...
HEADER = set(['No.', 'Date', 'ID', 'Narration', 'Debit',
              'Credit', 'AccountBalance', 'Remarks'])

MAX_START_DAY_OF_MONTH = 5
MIN_END_DAY_OF_MONTH = 25


class OrientalBankOfCommerceBankStatementsA(object):
    """Class to analyse the data obtained from Oriental Bank Of Commerce Type A"""
    ...
    def data_json(self, threshhold):
        data = {
            ...
            'bank_name': 'Oriental Bank Of Commerce Type A',
        }
        return data
