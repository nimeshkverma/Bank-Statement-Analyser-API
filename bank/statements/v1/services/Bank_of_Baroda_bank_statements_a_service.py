...
HEADER = set(['S.No', 'Date', 'Description', 'Cheque',
              'Debit', 'Credit', 'Balance', 'Value Date'])

MAX_START_DAY_OF_MONTH = 5
MIN_END_DAY_OF_MONTH = 25


class BankOfBarodaBankStatementsA(object):
    """Class to analyse the data obtained from Bank of Baroda Bank Type A"""
    ...
    def data_json(self, threshhold):
        data = {
            ...
            'bank_name': 'Bank of Baroda Type A',
        }
        return data
